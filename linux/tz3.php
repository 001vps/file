...
<div id="page">
	...
	<table>
		<tr>
			...
			<th class="w_top"><a href="#w_module">PHP已编译模块检测</a></th>
			<th class="w_top"><a href="#w_module">PHP已编译模块检测</a></th>


		<th class="w_top"><a href="<?php echo $_SERVER['PHP_SELF']."?act=phpinfo";?>">PHP信息（phpinfo）</a></th>
...
?></span>
	...
	<table>
		<tr>
			<td class="w_foot"><A HREF="http://123.haodianxin.cn" target="_blank"><?php echo $title.$version;?></A></td>
